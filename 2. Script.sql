...
CREATE TABLE CLIENTE (
    ...
    CONSTRAINT CHK_CLIENTE_EMAIL_FORMAT CHECK (EMAIL LIKE '%@%')
);
...
CREATE TABLE PROVEEDOR (
    ...
    CONSTRAINT CHK_PROVEEDOR_EMAIL_FORMAT CHECK (EMAIL LIKE '%@%')
);
...
-- ================================================
-- INSERTS DE DATOS (CORREGIDOS)
-- ================================================

-- CLIENTES
INSERT INTO CLIENTE (ID_CLIENTE, NOMBRE, EMAIL, TELEFONO, CATEGORIA) VALUES (1, 'Felipe Perez', 'felipe.perez@gmail.com', '+56987654321', 'PREMIUM');
INSERT INTO CLIENTE (ID_CLIENTE, NOMBRE, EMAIL, TELEFONO, CATEGORIA) VALUES (2, 'Camila Rojas', 'camila.rojas@hotmail.com', '+56991234567', 'REGULAR');
INSERT INTO CLIENTE (ID_CLIENTE, NOMBRE, EMAIL, TELEFONO, CATEGORIA) VALUES (3, 'José Martínez', 'jose.martinez@gmail.com', '+56999887766', 'NUEVO');
INSERT INTO CLIENTE (ID_CLIENTE, NOMBRE, EMAIL, TELEFONO, CATEGORIA) VALUES (4, 'Valentina Herrera', 'valentina.herrera@outlook.com', '+56955667788', 'PREMIUM');
INSERT INTO CLIENTE (ID_CLIENTE, NOMBRE, EMAIL, TELEFONO, CATEGORIA) VALUES (5, 'Diego Torres', 'diego.torres@gmail.com', '+56998765432', 'REGULAR');
INSERT INTO CLIENTE (ID_CLIENTE, NOMBRE, EMAIL, TELEFONO, CATEGORIA) VALUES (6, 'Fernanda González', 'fernanda.gonzalez@yahoo.com', '+56992345678', 'NUEVO');
INSERT INTO CLIENTE (ID_CLIENTE, NOMBRE, EMAIL, TELEFONO, CATEGORIA) VALUES (7, 'Matías Pérez', 'matias.perez@gmail.com', '+56999911122', 'PREMIUM');
INSERT INTO CLIENTE (ID_CLIENTE, NOMBRE, EMAIL, TELEFONO, CATEGORIA) VALUES (8, 'Constanza Rivera', 'constanza.rivera@gmail.com', '+56997776655', 'REGULAR');
INSERT INTO CLIENTE (ID_CLIENTE, NOMBRE, EMAIL, TELEFONO, CATEGORIA) VALUES (9, 'Felipe Navarro', 'felipe.navarro@icloud.com', '+56991112233', 'NUEVO');
INSERT INTO CLIENTE (ID_CLIENTE, NOMBRE, EMAIL, TELEFONO, CATEGORIA) VALUES (10, 'Daniela Soto', 'daniela.soto@gmail.com', '+56998887766', 'PREMIUM');
...
-- PRODUCTOS (TODOS CON PRECIO - CORREGIDO)
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (1, 1, 1, 'ZAPATILLAS AIR MAX 90', 89990, 'NEGRO', 'HOMBRE');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (2, 1, 2, 'ZAPATILLAS AIR FORCE 1', 84990, 'BLANCO', 'HOMBRE');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (3, 2, 3, 'POLO SPORT ADIDAS', 29990, 'AZUL', 'MUJER');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (4, 3, 4, 'HOODIE PUMA CLASSIC', 49990, 'GRIS', 'HOMBRE');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (5, 4, 5, 'JEANS LEVIS SLIM', 69990, 'AZUL', 'MUJER');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (6, 5, 6, 'CAMISETA H&M BÁSICA', 15990, 'BLANCO', 'UNISEX');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (7, 6, 7, 'CHAQUETA ZARA MODERNA', 64990, 'NEGRO', 'MUJER');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (8, 7, 8, 'VESTIDO GUESS FLORAL', 79990, 'ROJO', 'MUJER');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (9, 8, 9, 'SHORT UNDER ARMOUR RUN', 34990, 'NEGRO', 'HOMBRE');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (10, 9, 10, 'PARKA COLUMBIA EXTREME', 99990, 'VERDE', 'UNISEX');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (11, 6, 8, 'VESTIDO ZARA FLORAL', 59990, 'AZUL', 'MUJER');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (12, 5, 8, 'VESTIDO H&M FLORAL', 39990, 'ROSA', 'MUJER');
INSERT INTO PRODUCTO (ID_PRODUCTO, ID_MARCA, ID_MODELO, NOMBRE, PRECIO, COLOR, GENERO) VALUES (13, 2, 1, 'ZAPATILLAS ADIDAS AIR MAX', 79990, 'BLANCO', 'MUJER');
...
-- STOCK (SOLO PARA PRODUCTOS EXISTENTES 1-13)
...
INSERT INTO STOCK (ID_STOCK, ID_PRODUCTO, ID_TALLA, CANTIDAD) VALUES (11, 10, 3, 8);
INSERT INTO STOCK (ID_STOCK, ID_PRODUCTO, ID_TALLA, CANTIDAD) VALUES (12, 11, 2, 25);
INSERT INTO STOCK (ID_STOCK, ID_PRODUCTO, ID_TALLA, CANTIDAD) VALUES (13, 12, 3, 18);
INSERT INTO STOCK (ID_STOCK, ID_PRODUCTO, ID_TALLA, CANTIDAD) VALUES (14, 13, 3, 22);
...
-- DETALLE DE PEDIDOS (SOLO PRODUCTOS 1-10 QUE EXISTEN)
